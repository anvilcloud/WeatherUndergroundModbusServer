using AnvilCloud.WeatherApiClient.Contracts;
...
using WeatherUndergroundModbusServer.Devices;

namespace WeatherUndergroundModbusServer
{
    class Program
    {
        ...
        public static IHostBuilder CreateHostBuilder(string[] args)
        {
            return Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices((hostContext, services) =>
                {
                    ...
                    services.AddSingleton<ModbusConfiguration>(serviceProvider =>
                    {
                    ...
                    services.AddSingleton<WeatherConfiguration>(serviceProvider =>
                    {
                        var config = serviceProvider.GetRequiredService<IConfiguration>();
